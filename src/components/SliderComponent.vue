<template>
  <div>
    <div id="default-carousel" class="relative w-full" data-carousel="slide">
      <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
        <div
          ...
          :class="[
            ...
            { hidden: sliderStore.currentIndex !== index }
          ]"
        >
      ...
      >
        <button
          ...
          :class="[
            ...
            {
              'bg-gray-800': sliderStore.currentIndex === index,
              'bg-gray-300': sliderStore.currentIndex !== index
            }
          ]"
          type="button"
      ...
      >
        <span
          class="inline-flex items-center justify-center w-10 h-10 rounded-full bg-white/30 dark:bg-gray-800/30 group-hover:bg-white/50 dark:group-hover:bg-gray-800/60 group-focus:ring-3 group-focus:ring-white dark:group-focus:ring-gray-800/70 group-focus:outline-none"
        >
          <svg
