    ...
    <div class="container mx-auto px-4 py-8">
      <div class="flex flex-wrap -mx-4 relative">
        ...
        <div class="w-full md:w-1/2 px-4">
          ...
          <p class="text-gray-700 mb-6">Step up your sneaker game with the Air Force 1 Air Jordan "Orange-White-Black". A bold design that combines the iconic Air Force 1 silhouette with the striking colors of Jordan, ensuring you're on top of your sneaker game.</p>
...
export default {
  data() {
    return {
      mainImage: "/img/jordan.png", // Image for the new sneakers
      thumbnailImages: [
        "/img/jordan.png", // Thumbnail image for the new sneakers
        "/img/jordan.png"  // Thumbnail image for the new sneakers
      ],
      price: 250, // Price for the new sneakers
      quantity: 1,
      product: {
        name: "Air Force 1 Air Jordan 'ORANGE-WHITE-BLACK'",
        price: 250,
        image: "/img/jordan.png", // Image for the new sneakers
      },
