    ...
    <div class="container mx-auto px-4 py-8">
      <div class="flex flex-wrap -mx-4 relative">
        ...
        <div class="w-full md:w-1/2 px-4">
          ...
          <p class="text-gray-700 mb-6">Step up your sneaker game with the NIKE Air Force 1 Low Drake x NOCTA "Certified Lover Boy Citron Tint". A perfect fusion of classic Nike Air Force 1 styling with Drake's creative touch, featuring premium materials and a sleek, modern design.</p>
