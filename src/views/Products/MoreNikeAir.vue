    ...
    <div class="container mx-auto px-4 py-8">
      <div class="flex flex-wrap -mx-4 relative">
        ...
        <div class="w-full md:w-1/2 px-4">
          ...
          <p class="text-gray-600 mb-4">SKU: AF1DRAKE01</p>
          <div class="mb-4">
          ...
          <p class="text-gray-700 mb-6">
            ...
            Boy Citron Tint". A perfect fusion of classic Nike Air Force 1 styling with Drake's
...
export default {
  data() {
    return {
      mainImage: '/img/white-sneakers.png',
      thumbnailImages: ['/img/white-sneakers.png', '/img/white-sneakers.png'],
      price: 170,
      quantity: 1,
      product: {
