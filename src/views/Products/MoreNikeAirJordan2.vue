    ...
    <div class="container mx-auto px-4 py-8">
      <div class="flex flex-wrap -mx-4 relative">
        ...
        <div class="w-full md:w-1/2 px-4">
          ...
          <p class="text-gray-600 mb-4">SKU: JORDAN2BLACK01</p>
          <div class="mb-4">
          ...
          <div class="flex items-center mb-4">
            ...
            <span class="ml-2 text-gray-600">4.7 (200 reviews)</span>
          </div>
          <p class="text-gray-700 mb-6">The Jordan 2 'Black' combines style and performance with its iconic design and sleek black colorway. A perfect fusion of comfort, durability, and flair. Make your mark with every step.</p>
          ...
          <div>
            ...
            <ul class="list-disc list-inside text-gray-700">
              <li>Classic black colorway</li>
              <li>Iconic Jordan silhouette with premium materials</li>
              <li>Comfortable and durable construction</li>
              <li>Perfect for both casual and performance wear</li>
            </ul>
          </div>
...
export default {
  data() {
    return {
      mainImage: "/img/jordan1.png", // Image for the Jordan 2 'Black'
      thumbnailImages: [
        "/img/jordan1.png", // Thumbnail image for the Jordan 2 'Black'
        "/img/jordan1.png"  // Thumbnail image for the Jordan 2 'Black'
      ],
      price: 222, // Price for the Jordan 2 'Black'
      quantity: 1,
      product: {
        name: "JORDAN 2 'BLACK'",
        price: 222,
        image: "/img/jordan1.png", // Image for the Jordan 2 'Black'
      },
