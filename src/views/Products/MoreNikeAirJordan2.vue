      ...
      <div class="flex flex-wrap -mx-4 relative">
        ...
        <div class="w-full md:w-1/2 px-4">
          ...
          <p class="text-gray-700 mb-6">
            The Jordan 2 'Black' combines style and performance with its iconic design and sleek
            black colorway. A perfect fusion of comfort, durability, and flair. Make your mark with
            every step.
          </p>
