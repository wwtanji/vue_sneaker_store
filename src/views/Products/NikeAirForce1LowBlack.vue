      ...
      <div class="flex flex-wrap -mx-4 relative">
        ...
        <div class="w-full md:w-1/2 px-4">
          ...
          <p class="text-gray-700 mb-6">
            The NIKE Air Force 1 Low 'Black' offers a sleek, timeless design with premium materials
            and exceptional comfort, making it a must-have for every sneakerhead.
          </p>
