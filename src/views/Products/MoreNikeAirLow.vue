    ...
    <div class="container mx-auto px-4 py-8">
      <div class="flex flex-wrap -mx-4 relative">
        ...
        <div class="w-full md:w-1/2 px-4">
          ...
          <p class="text-gray-600 mb-4">SKU: AF1LOWBLACK01</p>
          <div class="mb-4">
          ...
          <div class="flex items-center mb-4">
            ...
            <span class="ml-2 text-gray-600">4.7 (150 reviews)</span>
          </div>
          <p class="text-gray-700 mb-6">The Nike Air Force 1 Low "Black" is the embodiment of timeless street style. Featuring a premium leather upper in black with the classic silhouette, these sneakers bring an edgy and modern twist to a legendary design.</p>
          ...
          <div>
            ...
            <ul class="list-disc list-inside text-gray-700">
              <li>Black leather upper for a versatile look</li>
              <li>Iconic Nike Air Force 1 silhouette</li>
              <li>Durable rubber outsole with great traction</li>
...
export default {
  data() {
    return {
      mainImage: "/img/rb_1651_3gen.png", // Image for the new sneakers
      thumbnailImages: [
        "/img/rb_1651_3gen.png", // Thumbnail image for the new sneakers
        "/img/rb_1651_3gen.png"  // Thumbnail image for the new sneakers
      ],
      price: 185, // Price for the new sneakers
      quantity: 1,
      product: {
        name: "NIKE AIR FORCE 1 LOW 'BLACK'",
        price: 185,
        image: "/img/rb_1651_3gen.png", // Image for the new sneakers
      },
