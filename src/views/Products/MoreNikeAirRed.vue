    ...
    <div class="container mx-auto px-4 py-8">
      <div class="flex flex-wrap -mx-4 relative">
        ...
        <div class="w-full md:w-1/2 px-4">
          ...
          <p class="text-gray-600 mb-4">SKU: AF1DRAKE02</p>
          <div class="mb-4">
          ...
          <p class="text-gray-700 mb-6">Step up your sneaker game with the NIKE Air Force 1 Low Drake x NOCTA "Certified Lover Boy Palest Purple". A perfect fusion of classic Nike Air Force 1 styling with Drake's creative touch, featuring premium materials and a sleek, modern design.</p>
          ...
          <div>
            ...
            <ul class="list-disc list-inside text-gray-700">
              ...
              <li>Custom Drake x NOCTA design</li>
              <li>Iconic Nike Air Force 1 silhouette</li>
              <li>Comfortable padded collar for all-day wear</li>
            </ul>
          </div>
...
export default {
  data() {
    return {
      mainImage: "/img/rb_1639.png", // Image for the new sneakers
      thumbnailImages: [
        "/img/rb_1639.png", // Thumbnail image for the new sneakers
        "/img/rb_1639.png"  // Thumbnail image for the new sneakers
      ],
      price: 200, // Price for the new sneakers
      quantity: 1,
      product: {
        name: "NIKE AIR FORCE 1 LOW DRAKE X NOCTA 'CERTIFIED LOVER BOY PALEST PURPLE'",
        price: 200,
        image: "/img/rb_1639.png", // Image for the new sneakers
      },
