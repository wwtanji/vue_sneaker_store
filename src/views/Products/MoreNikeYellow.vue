    ...
    <div class="container mx-auto px-4 py-8">
      <div class="flex flex-wrap -mx-4 relative">
        ...
        <div class="w-full md:w-1/2 px-4">
          ...
          <p class="text-gray-600 mb-4">SKU: AF1LOWLE01</p>
          <div class="mb-4">
          ...
          <div class="flex items-center mb-4">
            ...
            <span class="ml-2 text-gray-600">4.8 (200 reviews)</span>
          </div>
          <p class="text-gray-700 mb-6">These Nike Air Force 1 Low LE 'Triple White' (GS) are the perfect combination of timeless design and premium comfort. Featuring a sleek white leather upper, they offer a clean and versatile look that is perfect for everyday wear.</p>
          ...
          <div>
            ...
            <ul class="list-disc list-inside text-gray-700">
              <li>White leather upper for a clean look</li>
              <li>Breathable perforations for comfort</li>
...
export default {
  data() {
    return {
      mainImage: "/img/rb_1650.png", // Image for the new sneakers
      thumbnailImages: [
        "/img/rb_1650.png", // Thumbnail image for the new sneakers
        "/img/rb_1650.png"  // Thumbnail image for the new sneakers
      ],
      price: 230, // Price for the new sneakers
      quantity: 1,
      product: {
        name: "NIKE AIR FORCE 1 LOW LE 'TRIPLE WHITE' (GS)",
        price: 230,
        image: "/img/rb_1650.png", // Image for the new sneakers
      },
