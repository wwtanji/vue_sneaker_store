      ...
      <div class="flex flex-wrap -mx-4 relative">
        ...
        <div class="w-full md:w-1/2 px-4">
          ...
          <p class="text-gray-700 mb-6">
            The Nike Air Max "Black" provides a clean and sleek look with advanced cushioning
            technology for ultimate comfort. A perfect choice for everyday wear.
          </p>
          ...
          <div>
            ...
            <ul class="list-disc list-inside text-gray-700">
              <li>Premium quality black leather upper</li>
              <li>Air Max cushioning for all-day comfort</li>
              <li>Classic Nike design with a modern twist</li>
              <li>Durable and stylish for everyday use</li>
            </ul>
          </div>
...
export default {
  data() {
    return {
      mainImage: '/img/jordan4.png',
      thumbnailImages: ['/img/jordan4.png', '/img/jordan4.png'],
      price: 350,
      quantity: 1,
      product: {
