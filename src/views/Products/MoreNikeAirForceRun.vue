    ...
    <div class="container mx-auto px-4 py-8">
      <div class="flex flex-wrap -mx-4 relative">
        ...
        <div class="w-full md:w-1/2 px-4">
          ...
          <p class="text-gray-700 mb-6">The Nike Air Max "Black" provides a clean and sleek look with advanced cushioning technology for ultimate comfort. A perfect choice for everyday wear.</p>
